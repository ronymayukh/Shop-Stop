...
<script type="text/javascript">
        ...
        msg.pitch = 1; //0 to 2
        msg.text = 'this is the mp3 player section!';
        msg.lang = 'hi';
...
<div style="width:100%; height:auto;">
  ...
  <!--menu--> <div style="height:30px; width:100%; background-color:#269FB2; border:0px solid #269FB2;">
...
<!--slider down data-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where description='mp3'";
