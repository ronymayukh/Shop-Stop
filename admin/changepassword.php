 ...
 include('dbconnection.php');
	     ...
	     if(isset($_POST['sbt']))

	      {
			  ...
			  $qry=mysqli_query($bd," select * from login where user_name='".$_SESSION['name']."'");

			  $way=mysqli_fetch_array($qry);


			  if($way>0 && $way["password"]==$_POST["oldpwd"]){
...

				{
				 ...
				 $car=mysqli_query($bd,"update login set password='".$_POST['npwd']."' where user_name='".$_SESSION['name']."'");
   ...
   
				 {
					 ...
					 echo ("<script>alert('sorry passowrds don\'t match!')</script>");
